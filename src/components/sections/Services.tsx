...
const services: ServiceData[] = [
  ...
  },
  {
    ...
    images: [
      { src: img('gallery/image_14.webp'), alt: 'Progressiva - cabelo liso e brilhante' },
      { src: img('gallery/progressiva_2.webp'), alt: 'Progressiva - resultado liso' },
      { src: img('gallery/progressiva_3.webp'), alt: 'Progressiva - fios lisos e brilhantes' },
    ],
    delay: 'd3',
  },
  {
