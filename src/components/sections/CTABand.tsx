...
export default function CTABand() {
  ...
  return (
    <section className="cta-band" id="agendar">
      <div
        className={`cta-inner reveal${inView ? ' on' : ''}`}
        ref={ref}
      >
        <span className="cta-label">Sua transformação começa agora</span>
        <h2 className="cta-h">
          Pronta para amar<br /><em>seu cabelo de novo?</em>
        </h2>
        <p className="cta-p">
        ...
        <a href={WA_URL} className="cta-btn" target="_blank" rel="noopener noreferrer" onClick={() => trackWhatsApp('cta-band')}>
          <WhatsAppIcon />
