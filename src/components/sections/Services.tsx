...
const services: ServiceData[] = [
  {
    ...
    images: [
      { src: img('gallery/image_07.webp'), alt: 'Corte cacheado' },
      { src: img('gallery/image_08.webp'), alt: 'Corte midi liso' },
      { src: img('gallery/image_09.webp'), alt: 'Corte chanel ondulado' },
    ],
  },
  {
    id: 'svc-mechas',
    ...
    images: [
      { src: img('gallery/image_10.webp'), alt: 'Mechas iluminadas - tom acobreado' },
      { src: img('gallery/image_11.webp'), alt: 'Mechas iluminadas - loiro' },
      { src: img('gallery/image_12.webp'), alt: 'Cabelo cacheado loiro iluminado' },
      { src: img('gallery/image_13.webp'), alt: 'Mechas loiras estilo bali' },
    ],
    delay: 'd2',
  },
  {
    id: 'svc-alisamentos',
    name: 'Alisamentos',
    description: 'Liso duradouro, sem frizz e sem agredir os fios. Alisamentos que respeitam seu cabelo e entregam resultado que dura meses.',
    images: [
      { src: img('gallery/image_14.webp'), alt: 'Alisamentos - cabelo liso e brilhante' },
      { src: img('gallery/progressiva_2.webp'), alt: 'Alisamentos - resultado liso' },
      { src: img('gallery/progressiva_3.webp'), alt: 'Alisamentos - fios lisos e brilhantes' },
    ],
    delay: 'd3',
  },
  {
  ...
  },
  {
    ...
    images: [
      { src: img('gallery/image_17.webp'), alt: 'Coloração vermelha' },
